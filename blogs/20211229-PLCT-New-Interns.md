# 考研结束，快来实习吧，远程工作，做RISC-V开源软件！PLCT实验室所有实习岗位汇总

考研结束，是时候给自己的简历增加一些项目和实习经验啦！ RISC-V 是近年来非常火的一个技术方向，同学可以关注一下。 PLCT 实验室是国内做 RISC-V 开源软件生态建设的最活跃的团队之一，在编译技术领域有着较高的知名度，非常适合基础技术过硬动手coding能力超强的你。
