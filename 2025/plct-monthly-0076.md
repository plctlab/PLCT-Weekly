...
* Stars growth: 286 new GitHub stars across the org in November. Major gainers include `bpf-developer-tutorial` (+91), `bpftime` (+59), `schedcp` (+22), `agentsight` (+17), `eunomia.dev` (+16), plus steady growth for `eGPU`, `xpu-perf`, `GPUtrace`, `UVM_benchmark`, etc. ([GitHub][1])
