# PLCT 开源进展·第 67 期·2025 年 3 月 1 日（2月产出汇总）
...
## Eulaceura
- MahnoKropotkinvich
  - 移植yast-installation到Eulaceura，新移植了如下RPM包
  ```
  ...
  ```
    ...
    rubygem-yast-rake
    ```
  - 移植Trinity桌面环境到Eulaceura，编写spec文件并构建了以下包：
  ```
  tqt3
  ```
## Songsong Zhang

1、将sail部分前置依赖提交到Fedora上游

https://src.fedoraproject.org/rpms/ocaml-omd

https://src.fedoraproject.org/rpms/ocaml-linenoise

https://src.fedoraproject.org/rpms/ocaml-pprint
