# PLCT 开源进展·第 65 期·2025 年 1 月 1 日（2024年12月产出汇总）
...
[iscas]: https://mirror.iscas.ac.cn/ruyisdk/ruyi/tags/0.25.0/
...
* 调整了默认遥测模式为 `on`。后续会随着 RuyiSDK 软件源的更新，周期性上传匿名化的使用统计数据。遥测服务端位于中国大陆境内，由 RuyiSDK 团队管理。
...
* community/greetd\*: enable on riscv64
...
- 移植yast-installation到Eulaceura
  - yast-installation需要不少前置依赖，目前已成功移植如下npm包，[osc服务网站链接](https://build.tarsier-infra.isrc.ac.cn/project/show/home:MrGeek-zrh:branches:Eulaceura:Factory)：
  ```
  augeas
  ruby-common
  ...
  timezone
  ```
  - yast-installation需要的glibc版本比Eulaceura现在需要的版本高，在重新打包更高版本glibc的时候遇到了循环依赖问题，目前还在解决。

## Songsong Zhang

- [移植openGauss到Fedora RISC-V](https://mp.weixin.qq.com/s/FgxvzNrMYx6bl6BuuHCBRg)，目前已经提交[PR](https://gitee.com/opengauss/riscv/pulls/14)
