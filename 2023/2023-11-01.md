...
已完成同类RISC-V IDE调研，确定Eclipse类型和版本基准和需完成功能点初略设计。

目前正在对标Eclipse IDE for Embedded C/C++ Developers，集合其覆盖的各类插件的源码，初步形成RuyiSDK IDE的初始源码版本。目标是将集成的源码打包后能够产出功能等同于Eclipse IDE for Embedded C/C++ Developers的IDE安装程序。
...
## CAAT
- Chisel is switching to LLVM-Lit for testing! [1](https://github.com/chipsalliance/chisel/pull/3596)
- Chisel supports MLIR C-API to emit Verilog [1](https://github.com/chipsalliance/chisel/pull/3466) [2](https://github.com/chipsalliance/chisel/pull/3520) [3](https://github.com/chipsalliance/chisel/pull/3544) [4](https://github.com/chipsalliance/chisel/pull/3589) [5](https://github.com/chipsalliance/chisel/pull/3598)
- DecodeTable fixing as well as Rocket new Decoder [1](https://github.com/chipsalliance/chisel/pull/3563) [2](https://github.com/chipsalliance/rocket-chip/pull/3498)
- RocketChip support Chisel BFS [1](https://github.com/chipsalliance/rocket-chip/pull/3507)
- RocketChip removes Chisel 3.6 [1](https://github.com/chipsalliance/rocket-chip/pull/3515)
- Fix Xiangshan CIRCT bug [1](https://github.com/llvm/circt/issues/6124)
- All performance improvment in T1 [1](https://github.com/chipsalliance/t1/pulls)
...
- https://github.com/revyos/revyos/issues/34 [running 6.6 kernel on licheepi4a]
...
openEuler 在 10 月份正式纳入 RISC-V 为官方架构，openEuler RISC-V 23.09 主线化工作完成。
