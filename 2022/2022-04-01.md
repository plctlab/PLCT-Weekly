...
1. 我们非常高兴的宣布 LibreOffice for RISC-V 的 porting 工作已经有人接了。新加入 Tarsier Team 的钱耀津（Ryan）同学，在还没有搞清楚状况的状态下接下了重担。虽然整个3月份出了熟悉环境、尝试构建、并且去 LibreOffice 的BTS上开了个 issue/bug 宣称自己是要做 RISC-V porting 的钱耀津之外，什么外部可见的产出都还没有，但是，我们相信钱耀津同学一定是可以在今年搞定的！
