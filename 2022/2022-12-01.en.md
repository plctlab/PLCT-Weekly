# This Month in PLCT: Issue 40 (December 1, 2022)
...
2. Pull requests to jdk-mainline (as co-author):
...
3. jdk-mainline pull requests reviewed:
...
- Upstreamed changes.
  - [8296515: RISC-V: Small refactoring for MaxReductionV/MinReductionV/AddReductionV node implementation](https://github.com/openjdk/jdk/pull/11036)
  - [8297238: RISC-V: C2: Use Matcher::vector_element_basic_type when checking for vector element type in predicate](https://github.com/openjdk/jdk/pull/11239)
  - [RISC-V: Support vector api AddVI/AddVL mask node](https://github.com/zifeihan/jdk/commit/2889e115b82c7efd938c12753ea96e1e5fd1b3a9)
  - [RISC-V: Support vector api AndV/OrV/XorV mask node](https://github.com/zifeihan/jdk/commit/2bc4d2cab2601f2d20b212ac1dc7776564309b56)
  - [RISC-V: Matcher::min_vector_size Support vector api load/store mask](https://github.com/zifeihan/jdk/commit/8815fc567f95578152d8852bffd2b27656217926)
- Tool evaluation and testing.
  - [Java JVM profiling tools for Linux-RISCV64](https://github.com/jvm-profiling-tools/async-profiler/pull/644#issuecomment-1328474224)
...
3. Removing redundant code fragments.
...
https://github.com/openhwgroup/corev-binutils-gdb/pull/56
...
- Git Repository for Arch Linux RISC-V package patches, [archriscv-packages](https://github.com/felixonmars/archriscv-packages). A total of [121 Pull Requests](https://github.com/felixonmars/archriscv-packages/pulls?q=is%3Apr+is%3Amerged+merged%3A2022-11-01T00%3A00%3A00%2B08%3A00..2022-11-30T23%3A59%3A59%2B08%3A00+is%3Aclosed+) were submitted or merged for archriscv.
...
- [PR #22520 (merged)](https://github.com/opencv/opencv/pull/22520): Refactoring HSV colour space conversion functions using the new Universal Intrinsic framework.
- [Issues #22878](https://github.com/opencv/opencv/issues/22878): A proposal to use the `mask` type in the Universal Intrinsic framework (using RVV as a reference).

## Experimental/simd in LIBCXX

- Implemented a new high-coverage testing framework via our [OSPP Project](https://github.com/plctlab/llvm-project/pull/46).
...
- Updated CMO ACT support, awaiting merge, https://github.com/riscv-non-isa/riscv-arch-test/pull/226
...
- Introduced support for debug triggers (current problem: we only have support for type 6 but not type 2 triggers, no support for chained triggers, no support for chained install), [link](https://lists.infradead.org/pipermail/opensbi/2022-November/003535.html)
- Fixed a  build error in semihosting with LLVM (error: result of comparison of constant -1 with expression of type 'char' is always true), [link](https://lists.infradead.org/pipermail/opensbi/2022-November/003543.html)
- Split up `sbi_ecall_replace.c` so that each extension is in its individual file, [link](https://lists.infradead.org/pipermail/opensbi/2022-November/003554.html)
- Introduced support for sbi debug console, [link](https://lists.infradead.org/pipermail/opensbi/2022-November/003645.html)
- Avoid repeated reference to ae350 headers, [link](https://lists.infradead.org/pipermail/opensbi/2022-November/003596.html)
- generic/allwinner: Remove unused header files, [link](https://lists.infradead.org/pipermail/opensbi/2022-November/003606.html)
- allwinner移除奇怪的类型转换。[link](https://lists.infradead.org/pipermail/opensbi/2022-November/003610.html)
- generic/allwinner: Remove ghostly type cast, [link](https://lists.infradead.org/pipermail/opensbi/2022-November/003612.html)
- Fixed a Makefile issue for macOS, where `echo -n` is not supported, [link](https://lists.infradead.org/pipermail/opensbi/2022-November/003614.html)
- Makefile: bugfix for handling platform paths, [link](https://lists.infradead.org/pipermail/opensbi/2022-November/003621.html)
- sbi_domain: optimised MMIO matching, introduced `in_region`, optimised `sbi_domain_memregion_init` and `is_region_subset`, fixed `is_region_valid`, fixed an issue where the offset operation was not executed when the offset is at `__riscv_xlen`, [link](https://lists.infradead.org/pipermail/opensbi/2022-November/003641.html)
- Introduced various fixes for `fdt`, removing redundant argument checks, fixing data types, and improving error handling, [link](https://lists.infradead.org/pipermail/opensbi/2022-November/003690.html)
- Make use of `.insn` and `.word` based on compiler version to make disassembled code more readable, [link](https://lists.infradead.org/pipermail/opensbi/2022-November/003671.html)
- Introduced generic platform support for AE350, [link](https://lists.infradead.org/pipermail/opensbi/2022-November/003682.html)
- plic: Fix the off-by-one error in priority save/restore helpers, [link](https://lists.infradead.org/pipermail/opensbi/2022-November/003703.html)
- Optimised relocation (copying the program to the correct memory location), removing unneeded instructions by moving one jump, [link](https://lists.infradead.org/pipermail/opensbi/2022-November/003710.html)
- Introduced a macro for specifying boot hart (previously, opensbi uses atomic operations to randomly select boot hart), [link](https://lists.infradead.org/pipermail/opensbi/2022-November/003711.html)
