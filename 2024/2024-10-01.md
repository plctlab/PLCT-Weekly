...
- [从零开始的VSCode插件开发！顾钰老师B站首次公开课十月一日堂堂上线](https://mp.weixin.qq.com/s/LdAos6lsJ1br5FlzbcNcPg)
...
- [Box64 初步支持 RVV 1.0，最高300%性能提升，代码已开源并合入上游（upstream）](https://mp.weixin.qq.com/s/HxPo3ONjdJ52-Dsls8hl0A)
- [PLCT实验室加入乘影GPGPU 开源工具链项目, 加速推动对乘影GPGPU 64位指令集架构支持工作](https://mp.weixin.qq.com/s/9S-tBbL4Rx8lTXTN7lHNVA)
- [PLCT实验室启动 RuyiOS（如意OS）子项目：面向香山 RISC-V 开源 IP优化的 Debian 衍生发行版](https://mp.weixin.qq.com/s/S9efHuU6Jtj8YYWp-MmXFg)
...
9 月份 RuyiSDK 包管理器发布了 3 个新版本：0.17.0、0.18.0 与 0.19.0，对应
RuyiSDK 整体的 0.17、0.18 与 0.19 三个正式版本。您可移步
[GitHub Releases][GitHub Releases] 或 [ISCAS 镜像源][iscas]下载体验。

[GitHub Releases]: https://github.com/ruyisdk/ruyi/releases/tag/0.19.0
[iscas]: https://mirror.iscas.ac.cn/ruyisdk/ruyi/releases/0.19.0/

0.17.0 版本的变更已在上期报道。本月其余两个版本的主要变更如下：
...
Opened upstreaming Pull Request.
...
Using llm to analysis Linux kernel development:
...
- 代码[算能的cnpy-for-tpu_mlir](https://github.com/wwwuxy/cnpy-for-tpu_mlir)
- 代码[为算能cvibuilder重写readme，修改makefile中一处bug,已提交PR](https://github.com/sophgo/cvibuilder/pull/1)
- 代码[为算能cvikernel重写readme,已提交PR](https://github.com/sophgo/cvikernel/pull/1)
- 代码[为算能cviruntime重写readme,修改部分代码，已提交PR](https://github.com/sophgo/cviruntime/pull/2)
- 文章[《cviruntime安装部署》](https://zhuanlan.zhihu.com/p/738795038)
...
- 代码
- 文章
  1. [TPU-MLIR学习（一）](https://zhuanlan.zhihu.com/p/718042043)
  2. [tpu-mlir学习（二）量化](https://zhuanlan.zhihu.com/p/873462206)
  3. [Milk-V duo系列TPU后端cviruntime源码简析](https://zhuanlan.zhihu.com/p/873843089)
- 视频
