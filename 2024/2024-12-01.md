...
11 月份 RuyiSDK 包管理器发布了 2 个新版本：0.21.0 与 0.22.0，对应
RuyiSDK 整体的 0.21 与 0.22 两个正式版本，并提前准备了 0.23.0 等待于
12 月 3 日正式发布。您可移步
[GitHub Releases][GitHub Releases] 或 [ISCAS 镜像源][iscas]下载体验。

[GitHub Releases]: https://github.com/ruyisdk/ruyi/releases/tag/0.22.0
[iscas]: https://mirror.iscas.ac.cn/ruyisdk/ruyi/releases/0.22.0/
...
* 新增了 [RuyiSDK 的平台支持文档][ruyisdk-platform-support]，基于此完善了 RuyiSDK 包管理器的平台兼容性：
    ...
    * 以 CI 形式确保 `ruyi` 能够在 Python 3.10、3.11、3.12、3.13 这 4 个版本通过测试，有助于保障后续 `ruyi` 在多种 Linux 发行版上的兼容性。
...
## CIRCT
### Moore方言
刘生博：[ImportVerilog] Add stream concat operation. = https://github.com/llvm/circt/pull/7784 [Merge]
...
1. 共同： koji共编（RPM）包成功2922个

2. 刘海滨：
- 更新kojihub到最新，替换物理机kojid镜像，排查kojihub更新异常状态，编包，测试Mars开发版状态

3. 政宇：
- 向上游提交patch
* https://github.com/pjsip/pjproject/pull/4173

- 向Fedora提交pr
* https://src.fedoraproject.org/rpms/pjproject/pull-request/6
* https://src.fedoraproject.org/rpms/asterisk/pull-request/21

- 更新fedorariscv docker镜像
* https://hub.docker.com/r/fedorariscv/fedora-rv64-image-builder
* https://hub.docker.com/r/fedorariscv/base

- 制作 QEMU Fedora 41 image builder 镜像，并应用到所有Fedora worker
* https://openkoji.iscas.ac.cn/koji/taskinfo?taskID=6445595

- 完善 Fedora RISC-V 脚本
* https://github.com/fedora-riscv/image-maker/tree/test

- 制作Fedora vf2镜像，测试Visionfive V2开发版

4. 松松：
- https://src.fedoraproject.org/rpms/deepin-terminal
- https://src.fedoraproject.org/rpms/libEMF/pull-request/3
- https://src.fedoraproject.org/rpms/ruby/pull-request/195
- https://src.fedoraproject.org/rpms/sympy/pull-request/6
- https://src.fedoraproject.org/rpms/sundials/pull-request/5
- https://src.fedoraproject.org/rpms/python3.13/pull-request/124

5. 承熹：
- 更新了koji f41里面缺的包更新了镜像下载站，加了测试报告和讨论版，添加功能状态条
* https://images.fedoravforce.com/DC-ROMA%20II
* https://github.com/fedora-riscv/fedorav-force-images-discussions
* https://github.com/fedora-riscv/test-reports

- 更新了openkoji f41里面缺的包

- 初步完成安装脚本： https://github.com/fedora-riscv/fvf-image-burner
