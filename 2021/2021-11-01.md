...
- 实现和改进 aya 的 REPL ，添加相关的测试
  - REPL 雏形 [PR #85](https://github.com/aya-prover/aya-dev/pull/85)
  - 用 `Doc` 重写 REPL 输出 [PR #118](https://github.com/aya-prover/aya-dev/pull/118)
  - REPL 着色与语法高亮 [PR #121](https://github.com/aya-prover/aya-dev/pull/121)
  - REPL 补全 [PR #124](https://github.com/aya-prover/aya-dev/pull/124)
  - 新的 REPL 指令系统 [PR #131](https://github.com/aya-prover/aya-dev/pull/131)
  - REPL 的测试框架 [PR #130](https://github.com/aya-prover/aya-dev/pull/130)
- 改进二元运算符的语法
  - [PR #80](https://github.com/aya-prover/aya-dev/pull/80)
  - 中缀运算符语法 [PR #109](https://github.com/aya-prover/aya-dev/pull/109)
  - 接收一个显式参数的中缀运算符作为后缀运算符处理 [PR #112](https://github.com/aya-prover/aya-dev/pull/112)
  - 接收多于两个参数的运算符 [PR #114](https://github.com/aya-prover/aya-dev/pull/114)
- 优化类型检查器
  - 用模式匹配重写类型检查器(fix [issues #38](https://github.com/aya-prover/aya-dev/issues/38)) [PR#103 ~ PR #105](https://github.com/aya-prover/aya-dev/pull/105)
  - 添加 `TyckState` [PR #125](https://github.com/aya-prover/aya-dev/pull/125)
- 修复aya-lsp中的一些问题 [PR #113](https://github.com/aya-prover/aya-dev/pull/113)
- 优化报错信息 [PR #58](https://github.com/aya-prover/aya-dev/pull/58) | [PR #77](https://github.com/aya-prover/aya-dev/pull/58) | [PR #108](https://github.com/aya-prover/aya-dev/pull/58)
- 修改开源协议为 MIT license [PR #74](https://github.com/aya-prover/aya-dev/pull/74)
