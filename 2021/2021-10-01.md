...
补充下项目月重要进展，欢迎关注[项目](https://github.com/plctlab/openEuler-riscv/)，项目进展详见[项目双周报告](https://github.com/plctlab/openEuler-riscv/tree/main/weeklyreports)
...
1. 构建流程调整
   ...
   - 重新梳理工作流程：https://github.com/plctlab/openEuler-riscv/blob/main/quicklystartbuild/workflow-for-build-a-package.md
   - 对修复的包在关键结点建立跟踪表格：https://docs.qq.com/sheet/DUHFlV0haT2duWHBG?tab=BB08J2

2. 完成obs包抓取工具，并定期(每次构建完成后)抓取构建数据，对构建状态建立跟踪机制

   - obs包和构建状态抓取工具：https://github.com/plctlab/openEuler-riscv/tree/main/scripts/dependent_package
   - obs构建数据：
...
3. 对包的构建通过数据分析、问题分类的方式进行分析和任务分配（优先解决哪些包？哪些包容易被解决？共性问题处理等）：
...
4. openEuler:Mainline:RISC-V 包修复

| datetime      | succeeded | failed | unresolvable | broken | disabled | excluded |
| ------------- | --------- | ------ | ------------ | ------ | -------- | -------- |
| 20210922-1007 | 1924      | 211    | 1913         | 16     | 1        | 62       |
| 20210926-0747 | 2206      | 266    | 1576         | 16     | 1        | 62       |
| 20210930-1033 | 2309      | 170    | 1570         | 16     | 1        | 61       |

5. BaseOS for openEuler
...
6. 其他
   ...
   - 修复xfce版本   - 部分bug和添加输入法，lxde相关待安装测试
